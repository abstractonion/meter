...
See also: `component-craft-principles.md` for asymmetric enter/exit timing (the hold-to-delete press/release pattern), and `performance.md` for WAAPI-driven clip-path reveals.
