...
Concrete, reusable patterns for buttons, popovers, tooltips, and entrance transitions.
...
See also: `css-transforms.md` for `transform-origin` mechanics, `animation-decision-framework.md` for easing/duration choices, and `ui-review-protocol.md` for the review checklist rows these patterns map to.
